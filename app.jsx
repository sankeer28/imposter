      ...
      <div style={{
        ...
        <a href="https://github.com/sankeer28/imposter" target="_blank" rel="noopener noreferrer"
          style={{
            ...
            color: T.ink, textDecoration: 'none', flexShrink: 0,
          }}>
          ...
          {isImposter ? (
            <>
              <div style={{
                ...
                <div style={{
                  fontFamily: 'Archivo Black, sans-serif', fontSize: 46, lineHeight: 1,
                ...
                {hint && (
                  <div style={{
                    ...
                    <div style={{ marginTop: 6, color: T.paper, fontSize: 20, fontFamily: 'Archivo Black, sans-serif' }}>{hint}</div>
                  </div>
                )}
              </div>
            </>
